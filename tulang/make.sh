...
CFLAGS="-I/usr/local/Cellar/llvm/19.1.6/include -I./src  -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS"
...
MACOSX_DEPLOYMENT_TARGET=14.0 clang $CFLAGS -DDEBUG \
    src/main.c src/llvm/llvm.c src/llvm/llvm_var.c src/llvm/llvm_for.c src/llvm/llvm_expr.c src/llvm/llvm_call.c src/debug.c src/lexer.c src/parser.c src/compiler.c src/list.c \
